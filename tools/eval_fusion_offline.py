...
def main() -> int:
    ...
    ap.add_argument("data_dir", type=Path, help="Directory of CSV shots (time_ms,q_min[,Te_core,ne,...])")
    ...
    cfg = PlasmaMonitorConfig(state_dim=args.state_dim, rank=args.rank, curvature_alarm=args.curvature_alarm)
