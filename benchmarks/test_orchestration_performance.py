...
class SymbolicFreeEnergy:
    ...
    def compute(
        self, numerical_feats: Dict, model: Model, predictors: Dict, coherence: Any, met: Any
    ):
...
def mock_pgd_extractor_for_diverse_queries():
    pgd_extractor = MagicMock(spec=RegexPromptExtractor)
